...
CREATE DATABASE IF NOT EXISTS `aggregator` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `aggregator`;
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `customer_surname` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `customer_name` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `customer_patronymic` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `organization` (
  ...
  `organization_full_name` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `organization_short_name` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `inn` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kpp` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ogrn` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsible_person_surname` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsible_person_name` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsible_person_patronymic` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsible_person_email` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsible_person_phone_number` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `add_info` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `profile_image` char(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `organization` (`organization_id`, `organization_full_name`, `organization_short_name`, `inn`, `kpp`, `ogrn`, `responsible_person_surname`, `responsible_person_name`, `responsible_person_patronymic`, `responsible_person_email`, `responsible_person_phone_number`, `add_info`, `profile_image`) VALUES
	(3, 'dfdf', NULL, '132423', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(4, 'Dodo', NULL, '1234231', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dog.jpg'),
	(5, 'Dodo', NULL, '1234', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ciric.jpg'),
	(7, 'Dodo', NULL, '3434343243', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'los.jpg');

-- Дамп структуры для таблица aggregator.registrations
CREATE TABLE IF NOT EXISTS `registrations` (
  `registrations_id` int NOT NULL AUTO_INCREMENT,
  `username` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `registrations` (`registrations_id`, `username`, `password`) VALUES
